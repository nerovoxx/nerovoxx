<p align="center">
  <img src="https://emailnero.gt.tc/vvv.png?raw=true" width="100%" align="top" alt="NeroVoxx Cloud Security & Automation Engineer Banner"/><br><a href="https://linkedin.com/in/nerovoxx"><img src="https://placehold.co/400x150/0b0f19/42e2f1?text=R1+SLICE+A:+LINKEDIN" width="33.33%" align="top" alt="Row 1 Slice A"/></a><a href="https://github.com/nerovoxx/nerovault"><img src="https://placehold.co/400x150/090d16/9b5de5?text=R1+SLICE+B:+NEROVAULT" width="33.33%" align="top" alt="Row 1 Slice B"/></a><a href="https://nerovoxx.com"><img src="https://placehold.co/400x150/0b0f19/5199ff?text=R1+SLICE+C:+WEBSITE" width="33.34%" align="top" alt="Row 1 Slice C"/></a><br><a href="https://linkedin.com/in/nerovoxx"><img src="https://placehold.co/400x150/0000FF/ffffff?text=R2+SLICE+A:+LINKEDIN" width="33.33%" align="top" alt="Row 2 Slice A"/></a><a href="https://github.com/nerovoxx/nerovault"><img src="https://placehold.co/400x150/0000FF/ffffff?text=R2+SLICE+B:+NEROVAULT" width="33.33%" align="top" alt="Row 2 Slice B"/></a><a href="https://nerovoxx.com"><img src="https://placehold.co/400x150/0000FF/ffffff?text=R2+SLICE+C:+WEBSITE" width="33.34%" align="top" alt="Row 2 Slice C"/></a>
</p>
...
I specialize in the intersection of **Cloud Architecture** and **Automated Security Operations**, moving beyond manual compliance toward self-healing infrastructure. With a background in Full-Stack software engineering, I build production-grade security applications, automated threat remediation scripts, and high-utility dashboards.

### 🛡️ Security Operations & Infrastructure
* **Multi-Tenancy Isolation:** Engineered **NeroVault** featuring rigorous database-level data separation via Global Scopes and middleware-driven identity gates.
* **Automated Threat Mitigation:** Built agentic brute-force detection tools reducing unauthorized authentication attempts by **90%** via automated IP-throttling.
* **Network Modeling:** Deep-layer configuration capability in **IPv4 Subnetting** and **RIPv2 Routing** validated via high-fidelity Cisco environments.
...
## My Tech Stack
CLOUD & SECURITY :: AWS (IAM, S3, CloudTrail, GuardDuty) | SIEM | Linux Hardening | Cisco Networking
